...
open class OoResponse(val status: String?, val timestamp: String?) : Serializable {
...
class OoDataResponse<T>(status: String?, timestamp: String?, val data: T) : OoResponse(status, timestamp), Serializable {
    override fun toString(): String {
...
class OoErrorResponse(status: String?, timestamp: String?, val error: OoError?) : OoResponse(status, timestamp), Serializable {
    override fun toString(): String {
